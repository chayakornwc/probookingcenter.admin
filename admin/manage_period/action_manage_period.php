            ...
            foreach($value as $key_i => $value_i){
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        //href="http://localhost/probookingcenter.admin/admin/booking/manage_booking.php?book_id='.$row['book_id'].'&book_code='.$row['book_code'].'" target="_blank"
                ...
                if( $fullPaymentTotal==intval($value_i['per_qty_seats']) ){
                    ...
                    $txt = '<a class="mb-sm btn btn-xs btn-warning" href="http://localhost/probookingcenter.admin/admin/booking/manage_booking.php?per_id='.$value_i['per_id'].'&bus_no='.$value_i['bus_no'].'" target="_blank"><em class="icon-list"></em> W/L</a> ';
                }
