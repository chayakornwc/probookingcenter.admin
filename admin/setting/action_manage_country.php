...
if($_REQUEST['method'] == 1){//select list
    ...
    $wsfolder	= '/manage_country';      # กำหนด Folder
    ...
    $thead = ' <thead>
                    <tr>
                        ...
                        <th class="text-center" width="40%">ชื่อประเทศ</th>
    ...
    if($data_return['status'] != 200){
        ...
        foreach($result as $key => $value){
            ...
            $td .= '<td class="text-center">
                         <button type="button" class="mb-sm btn btn-primary btn-xs" onclick="manage_country(\'update\','.$value['country_id'].')">
    ...
    if($action_method == 'add'){
        ...
        $wsserver   = URL_WS;                   # ../unity/post_to_ws/config.php
        $wsfolder	= '/manage_country';      # กำหนด Folder
        $wsfile		= '/select_by_id_country.php';     # กำหนด File
        $url 		= $wsserver.$wsfolder.$wsfile; // กำหนด URL
        $data 		= array(
        ...
        if($data_return['status'] == 200){
            ...
            $country_deposit = intval($result['country_deposit']);
    ...
    $set_data['modal'] = '<div id="modal-manage-country" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <h4 id="myModalLabel" class="modal-title">'.$title_modal.'ประเทศ</h4>
                                    </div>
                                    <div class="modal-body">

                                        <div class="form-horizontal">

                                            <input type="hidden" value="'.$country_id.'" id="country_id" name="country_id">
                                            <input type="hidden" value="'.$country_name.'" id="country_name_old" name="country_name_old">

                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">ชื่อประเทศ :</label>
                                                <div class="col-lg-7">
                                                    <input type="text" value="'.$country_name.'" class="form-control" id="country_name" name="country_name">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">จำนวนเงินมัดจำ :</label>
                                                <div class="col-lg-7">
                                                    <input type="text" value="'.$country_deposit.'" class="form-control input_number" id="country_deposit" name="country_deposit">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="radio c-radio">
                                                    <label>
                                                        <input type="radio" name="country_status" class="status_1" value="1" '.$country_status_1.'>
                                                ...
                                                <div class="radio c-radio">
                                                    <label>
                                                        <input type="radio" name="country_status" class="status_2" value="2" '.$country_status_2.'>
                                                        <span class="fa fa-circle"></span>
                                                            ระงับการใช้งาน
                                                        </label>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="check_submit_country('.$method.')">
    ...
    $wsserver   =   URL_WS;                   # ../unity/post_to_ws/config.php
    $wsfolder	=   '/manage_country';      # กำหนด Folder
    $wsfile		=	'/insert_country.php';     # กำหนด File
    $url 		=	$wsserver.$wsfolder.$wsfile; // กำหนด URL
    $data 		=	array(  
    ...
    $wsserver   =   URL_WS;                   # ../unity/post_to_ws/config.php
    $wsfolder	=   '/manage_country';      # กำหนด Folder
    $wsfile		=	'/update_country.php';     # กำหนด File
    $url 		=	$wsserver.$wsfolder.$wsfile; // กำหนด URL
    $data 		=	array(  
    ...
    if($_REQUEST['country_name'] != $_REQUEST['country_name_old']){


        #WS
        $wsserver   =   URL_WS;                   # ../unity/post_to_ws/config.php
        $wsfolder	=   '/manage_country';      # กำหนด Folder
        $wsfile		=	'/check_countryname.php';     # กำหนด File
        $url 		=	$wsserver.$wsfolder.$wsfile; // กำหนด URL
        $data 		=	array(  
                                'country_name'      => $_REQUEST['country_name'],
                                'method'          => 'GET'
