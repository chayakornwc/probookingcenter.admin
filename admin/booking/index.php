                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <label class="checkbox-inline c-checkbox">
                                    <input id="status_05" type="checkbox" value="05" checked>
                                <span class="fa fa-check"></span>W/L
                            </label>
                        </div>
    ...
    <script>
        ...
        function search_page(){
            ...
            data_search = {
                ...
                status_05    : IS_CHECKED($('#status_05')),
     ...
     $('#interface_table').delegate('.js-passport', 'click', function(){
       var $this = $(this).data('target');
       const URL ='../booking/zip_passport/'+$this
        $.ajax({
            url:URL,
            type:'GET',
            data:{'Authentication':<?=($_SESSION['login']['user_id'])?>}
        }).done(function(res){
          window.location = URL;
        })
     });
